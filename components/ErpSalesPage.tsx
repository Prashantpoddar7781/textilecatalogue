...
export const ErpSalesPage: React.FC<Props> = ({ onBack }) => {
  ...
  const saveEntry = async () => {
    if (transactionType === 'SALES ORDERS') {
      window.location.href = '/erp/sales-order';
      return;
    }
      ...
      <main className="mx-auto max-w-7xl px-4 py-6">
        <section className="rounded-3xl border border-gray-100 bg-white p-5 shadow-sm">
          ...
          <p className="mt-1 text-xs text-gray-500">
            Select type head. Choose <strong>SALES ORDERS</strong> to open the Sales Order form.
          </p>
          ...
          <ErpFormShell onSave={saveEntry} saving={saving}>
            <div className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
              <div>
                ...
                <select
                  ...
                  onChange={e => {
                    ...
                    if (value === 'SALES ORDERS') window.location.href = '/erp/sales-order';
                  }}
                >
              ...
              <div>
                ...
                <input readOnly className="w-full rounded-xl border bg-gray-100 px-3 py-2.5 text-sm font-black" value={typeBillNumber ?? '—'} />
              </div>
              <div>
