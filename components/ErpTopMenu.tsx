          ...
          <div className="relative">
            ...
            {openMenu === 'accounts' && (
              <div className={`${menuPanelClass} min-w-[220px]`}>
                ...
                <button
                  type="button"
                  onClick={() => { window.location.href = '/erp/expenses'; }}
                  className="flex w-full items-center gap-2 rounded-lg px-3 py-2.5 text-left text-sm font-semibold text-gray-800 hover:bg-indigo-50 hover:text-indigo-700"
                >
                ...
                <button
                  type="button"
                  onClick={() => { window.location.href = '/erp/notes'; }}
                  className="flex w-full items-center gap-2 rounded-lg px-3 py-2.5 text-left text-sm font-semibold text-gray-800 hover:bg-indigo-50 hover:text-indigo-700"
                >
          ...
          <div className="relative">
            ...
            {openMenu === 'reports' && (
              <div className={`${menuPanelClass} min-w-[240px]`}>
                ...
                <button
                  type="button"
                  onClick={() => { window.location.href = '/erp/reports/stock'; }}
                  className="flex w-full items-center gap-2 rounded-lg px-3 py-2.5 text-left text-sm font-semibold text-gray-800 hover:bg-indigo-50 hover:text-indigo-700"
                >
                  <FileBarChart className="h-4 w-4" />
                  Stock Balances / Stock Report
                </button>
                <button
                  type="button"
                  onClick={() => { window.location.href = '/erp/reports/gstr-3b'; }}
                  className="flex w-full items-center gap-2 rounded-lg px-3 py-2.5 text-left text-sm font-semibold text-gray-800 hover:bg-indigo-50 hover:text-indigo-700"
                >
                  <FileBarChart className="h-4 w-4" />
                  GSTR-3B / ITC Split
                ...
                <button
                  type="button"
                  onClick={() => { window.location.href = '/erp/reports/finish-purchase'; }}
                  className="flex w-full items-center gap-2 rounded-lg px-3 py-2.5 text-left text-sm font-semibold text-gray-800 hover:bg-indigo-50 hover:text-indigo-700"
                >
                  <FileBarChart className="h-4 w-4" />
                ...
                <button
                  type="button"
                  onClick={() => { window.location.href = '/erp/reports/expenses'; }}
                  className="flex w-full items-center gap-2 rounded-lg px-3 py-2.5 text-left text-sm font-semibold text-gray-800 hover:bg-indigo-50 hover:text-indigo-700"
                >
                  <FileBarChart className="h-4 w-4" />
                  Expenses Report
                ...
                <button
                  type="button"
                  onClick={() => { window.location.href = '/erp/reports/final-accounts'; }}
                  className="flex w-full items-center gap-2 rounded-lg px-3 py-2.5 text-left text-sm font-semibold text-gray-800 hover:bg-indigo-50 hover:text-indigo-700"
                >
                  <FileBarChart className="h-4 w-4" />
                  Final Accounts
