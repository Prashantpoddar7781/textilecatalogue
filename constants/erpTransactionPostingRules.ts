...
export function isBillingSeries(transactionType?: string | null): boolean {
...
/** PREVIOUS LINK — the series this document is raised against. */
export function getPreviousLink(transactionType?: string | null): string | null {
  return getPostingRule(transactionType)?.previousLink || null;
}

/** NEXT LINK — the series that consumes this document. */
export function getNextLink(transactionType?: string | null): string | null {
 ...
 */
export function getSourceSeriesFor(transactionType?: string | null): string[] {
  const upper = String(transactionType || '').trim().toUpperCase();
  if (!upper) return [];
...
export function getTargetSeriesFor(transactionType?: string | null): string[] {
  const upper = String(transactionType || '').trim().toUpperCase();
  if (!upper) return [];
...
export function requiresCompulsoryLink(transactionType?: string | null): boolean {
...
export function copiesItemDetailsFromSource(transactionType?: string | null): boolean {
...
export function showsAllEntriesInPick(transactionType?: string | null): boolean {
...
export function warnsOnManualEntry(transactionType?: string | null): boolean {
  return getPostingRule(transactionType)?.warnOnManualEntry === true;
}

/** Default GST rate for the series: CGST% + SGST% from the master. */
export function postingGstRate(transactionType?: string | null): number | null {
  const found = getPostingRule(transactionType);
 ...
 */
export function getItcEligibility(transactionType?: string | null): ErpItcEligibility | null {
  const found = getPostingRule(transactionType);
 ...
 */
export function gstDocumentSign(transactionType?: string | null): number {
  const u = String(transactionType || '').trim().toUpperCase();
